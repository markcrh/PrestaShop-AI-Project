...
<div id="search_filters">
    ...
    {foreach from=$facets item="facet"}
        {if $facet.displayed}
            <section class="facet clearfix block-left-column">
                <h1 class="h6 facet-title hidden-sm-down title_block title-block-left-column"><span class="title_left_column">{l s='Filter By' d='Shop.Theme.Actions'} {$facet.label}</span></h1>
                ...
                <div class="title hidden-md-up" data-target="#facet_{$_expand_id}" data-toggle="collapse"{if !$_collapse} aria-expanded="true"{/if}>
                    <h1 class="h6 facet-title">{l s='Filter By' d='Shop.Theme.Actions'} {$facet.label}</h1>
              ...
              <span class="navbar-toggler collapse-icons">
                ...
                {if $facet.widgetType !== 'dropdown'}
                    ...
                    {block name='facet_item_other'}
                        <ul id="facet_{$_expand_id}" class="content-block-left-column facet_content collapse{if !$_collapse} in{/if}">
                            {foreach from=$facet.filters item="filter"}
                                {if $filter.displayed}
                                    <li>
